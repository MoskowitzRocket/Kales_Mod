package net.moskowitzrocket.tutorialmod.block;
...
import net.moskowitzrocket.tutorialmod.block.custom.SpeedyBlock;
import net.moskowitzrocket.tutorialmod.item.ModItemGroup;
